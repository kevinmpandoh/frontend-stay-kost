...
const AppHeader: React.FC = () => {
  ...
  // useSocketNotification(user?.id || "");

  // const { notifications, isLoading, isError } = useNotification();

  // console.log(notifications, "NOTIFNYA ");
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
        <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
          <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
            <button
              className="z-30 h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:flex lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
